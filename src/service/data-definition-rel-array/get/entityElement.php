...
class GenDataDefinitionRelArray_entityElementGet extends GenerateEntityRecursiveFk {
  protected $names = [];
  ...
  protected function body(Entity $entity, $prefix, Field $field = null){
    ...
    $this->string .= "      switchMap(
        (data:{ [index: string]: any; }[]) => {
          ...
          return (isEmptyObject(f)) ? of(data) : this.dd.getColumnData(data, '" . $prf2 . $field->getName() . "', '" . $entity->getName() ."', f)
        }
      ),
";
  }
